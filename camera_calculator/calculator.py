...
class Calculator:
    def __init__(self, model, categories, time_to_focus):
        ...
        #time the calculator wait once the number of symbols stay the same before calculating the equation
    ...
    def calculate_equation(self):
        ...
        #once an operation is received, add both number and the operation to opeartions_stack and reset the number
        operations_stack = []
        number = ""
